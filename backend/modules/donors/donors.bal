...
//         if latStr is () || lonStr is () || radStr is () {
//             return error("Missing query parameters: latitude, longitude, and radius are required");
//         }

//         float|error latitude = float:fromString(latStr);
//         float|error longitude = float:fromString(lonStr);
//         float|error radius = float:fromString(radStr);

//         if latitude is error || longitude is error || radius is error {
//             return error("Invalid query parameters: latitude, longitude, and radius must be valid numbers");
//         }
