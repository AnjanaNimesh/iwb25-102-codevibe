...
const ViewBloodStock = () => {
  ...
  }, [hospitalsData, searchTerm, selectedDistrict]);
      ...
      <div className="container mx-auto px-4 py-4 sm:py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-8 sm:pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base"
                value={searchTerm}
            ...
            <div className="relative">
              ...
              <select
                className="w-full pl-8 sm:pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 appearance-none bg-white text-sm sm:text-base"
        ...
        <div className="space-y-4 sm:space-y-6 mb-6">
          {paginatedHospitals.map((hospital, index) => (
            <div key={`${hospital.name}-${hospital.district}`} className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                      ...
                      return (
                        <div 
                          ...
                          className={`p-2 sm:p-3 rounded-lg border transition-all ${
                            shouldHighlight ? 'border-red-200 bg-red-50' : 'border-gray-200'
                          }`}
                        >
                          <div className="text-center">
