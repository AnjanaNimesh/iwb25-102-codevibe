...
import { useNavigate } from 'react-router-dom';
import { 
  FaTint, FaUser, FaEnvelope, FaPhone, FaLock, 
  FaMapMarkerAlt, FaVenusMars, FaEye, FaEyeSlash, FaCalendarAlt, FaTimes 
} from 'react-icons/fa';
import { MdBloodtype } from 'react-icons/md';
...
const DonorSignup: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 via-white to-pink-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="relative max-w-2xl w-full space-y-8 bg-white p-8 rounded-2xl shadow-2xl border border-red-100">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  onClick={() => setShowPassword(!showPassword)}
                >
                  {showPassword ? <FaEyeSlash className="h-4 w-4 text-gray-400 hover:text-gray-600" /> : <FaEye className="h-4 w-4 text-gray-400 hover:text-gray-600" />}
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  onClick={() => setShowConfirmPassword(!showConfirmPassword)}
                >
                  {showConfirmPassword ? <FaEyeSlash className="h-4 w-4 text-gray-400 hover:text-gray-600" /> : <FaEye className="h-4 w-4 text-gray-400 hover:text-gray-600" />}
                </button>
              </div>
            </div>
          </div>
