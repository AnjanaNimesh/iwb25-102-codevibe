...
//       title: "Large Network",
//       description: "500+ hospitals and 10,000+ active donors"
//     },
//     {
...
//           <button className="bg-white text-red-500 px-8 py-4 rounded-full font-bold hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg">
//             Get Started Today
//           </button>
//         </div>
//       </div>
